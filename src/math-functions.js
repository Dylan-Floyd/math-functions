...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    result.push(product);
    result.push(`${a} and ${b} and ${c} sum to ${summ}.`);
    result.push(`The product of ${a} and ${b} and ${c} is ${product}.`);
    return result;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    result.push(product);
    result.push(`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${product}.`);
    return result;
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    result.push(product);
    let infoString = 'The numbers ';
    for(let i = 0; i < dynamicArray.length - 1; i = sum(i, 1)[0]) {
        infoString += `${dynamicArray[i]},`;
    }
    infoString += dynamicArray[dynamicArray.length - 1] + ` have a product of ${ product }.`;
    result.push(infoString);
    return result;
}
